...
use Tests\Core\Helpers\FaturaLogTester;
...
class MigrateGenerateCommand extends GeneratorCommand
{
    ...
    {
       return FaturaLogTester::getTestTables(true);
...
//        $this->generateForeignKeys($tables);
    ...
    protected function generateTablesAndIndices(array $tables)
    {
        ...
        foreach ($tables as $table) {
            ...
            $this->fields = $this->schemaGenerator->getFields(str_replace_first('test_', '', $this->table));
    ...
    protected function generate()
    {
        if ($this->fields) {
            ...
            var_dump('No fields found for table: ' .$this->table);
        }
    }
